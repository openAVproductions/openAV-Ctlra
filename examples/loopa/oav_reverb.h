...
#ifndef  __roomy_t_H__
#define  __roomy_t_H__
...
static float roomy_t_faustpower2_f(float value) {
	return (value * value);
}

#ifndef FAUSTCLASS 
#define FAUSTCLASS roomy_t
#endif
#ifdef __APPLE__ 
...
roomy_t* newroomy_t() { 
	roomy_t* dsp = (roomy_t*)calloc(1, sizeof(roomy_t));
	return dsp;
}

void deleteroomy_t(roomy_t* dsp) { 
	free(dsp);
}

int getSampleRateroomy_t(roomy_t* dsp) {
	return dsp->fSamplingFreq;
}

int getNumInputsroomy_t(roomy_t* dsp) {
	return 2;
	
}
int getNumOutputsroomy_t(roomy_t* dsp) {
	return 2;
	
}
int getInputRateroomy_t(roomy_t* dsp, int channel) {
	int rate;
	switch (channel) {
		case 0: {
			rate = 1;
...
int getOutputRateroomy_t(roomy_t* dsp, int channel) {
	int rate;
	switch (channel) {
		case 0: {
			rate = 1;
...
void classInitroomy_t(int samplingFreq) {
	
}

void instanceResetUserInterfaceroomy_t(roomy_t* dsp) {
	dsp->fVslider_level = (FAUSTFLOAT)-20.0f;
...
void instanceClearroomy_t(roomy_t* dsp) {
	/* C99 loop */
	{
		int l0;
...
void instanceConstantsroomy_t(roomy_t* dsp, int samplingFreq) {
	dsp->fSamplingFreq = samplingFreq;
	dsp->fConst0 = fmin(192000.0f, fmax(1.0f, (float)dsp->fSamplingFreq));
	...
	dsp->iConst7 = ((int)(dsp->fConst2 - dsp->fConst6) & 16383);
	dsp->fConst8 = (0.00100000005f * dsp->fConst0);
	dsp->iConst9 = ((int)(dsp->fConst6 + -1.0f) & 1023);
	...
	dsp->iConst13 = ((int)(dsp->fConst10 - dsp->fConst12) & 16383);
	dsp->iConst14 = ((int)(dsp->fConst12 + -1.0f) & 2047);
	...
	dsp->iConst18 = ((int)(dsp->fConst15 - dsp->fConst17) & 8191);
	dsp->iConst19 = ((int)(dsp->fConst17 + -1.0f) & 2047);
	...
	dsp->iConst23 = ((int)(dsp->fConst20 - dsp->fConst22) & 16383);
	dsp->iConst24 = ((int)(dsp->fConst22 + -1.0f) & 2047);
	...
	dsp->iConst28 = ((int)(dsp->fConst25 - dsp->fConst27) & 8191);
	dsp->iConst29 = ((int)(dsp->fConst27 + -1.0f) & 1023);
	...
	dsp->iConst33 = ((int)(dsp->fConst30 - dsp->fConst32) & 8191);
	dsp->iConst34 = ((int)(dsp->fConst32 + -1.0f) & 2047);
	...
	dsp->iConst38 = ((int)(dsp->fConst35 - dsp->fConst37) & 8191);
	dsp->iConst39 = ((int)(dsp->fConst37 + -1.0f) & 2047);
	...
	dsp->iConst43 = ((int)(dsp->fConst40 - dsp->fConst42) & 8191);
	dsp->iConst44 = ((int)(dsp->fConst42 + -1.0f) & 1023);
	
}

void instanceInitroomy_t(roomy_t* dsp, int samplingFreq) {
	instanceConstantsroomy_t(dsp, samplingFreq);
	instanceResetUserInterfaceroomy_t(dsp);
	instanceClearroomy_t(dsp);
}

void initroomy_t(roomy_t* dsp, int samplingFreq) {
	classInitroomy_t(samplingFreq);
	instanceInitroomy_t(dsp, samplingFreq);

	/* highjack defaults */
	dsp->fVslider6 = 2.f;
	dsp->fVslider8 = 6.f;
	dsp->fVslider1 = -0.6f;
	dsp->fVslider_level = 0.f; // db
}

#ifdef USE_UI_GLUE
void buildUserInterfaceroomy_t(roomy_t* dsp, UIGlue* ui_interface) {
	ui_interface->declare(ui_interface->uiInterface, 0, "0", "");
	ui_interface->declare(ui_interface->uiInterface, 0, "tooltip", "~ ZITA REV1 FEEDBACK DELAY NETWORK (FDN) & SCHROEDER       ALLPASS-COMB REVERBERATOR (8x8). See Faust's reverb.lib for documentation and       references");
	...
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVslider_level, "2", "");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVslider_level, "style", "knob");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVslider_level, "tooltip", "Output scale    factor");
	ui_interface->declare(ui_interface->uiInterface, &dsp->fVslider_level, "unit", "dB");
	ui_interface->addVerticalSlider(ui_interface->uiInterface, "Level", &dsp->fVslider_level, -20.0f, -70.0f, 40.0f, 0.100000001f);
	ui_interface->closeBox(ui_interface->uiInterface);
	ui_interface->closeBox(ui_interface->uiInterface);
...
void computeroomy_t(roomy_t* dsp, int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
	FAUSTFLOAT* input0 = inputs[0];
	FAUSTFLOAT* input1 = inputs[1];
	FAUSTFLOAT* output0 = outputs[0];
	FAUSTFLOAT* output1 = outputs[1];
	float fSlow0 = (0.00100000005f * powf(10.0f, (0.0500000007f * (float)dsp->fVslider_level)));
	...
	float fSlow4 = (dsp->fConst1 * (fSlow2 / sqrtf(fmax(0.0f, fSlow3))));
	...
	float fSlow17 = sqrtf(fmax(0.0f, ((roomy_t_faustpower2_f(fSlow14) / roomy_t_faustpower2_f(fSlow15)) + -1.0f)));
	...
	int iSlow26 = ((int)(dsp->fConst8 * (float)dsp->fVslider10) & 8191);
	float fSlow27 = expf((dsp->fConst11 / fSlow10));
	float fSlow28 = roomy_t_faustpower2_f(fSlow27);
	float fSlow29 = (1.0f - (fSlow13 * fSlow28));
	float fSlow30 = (1.0f - fSlow28);
	float fSlow31 = (fSlow29 / fSlow30);
	float fSlow32 = sqrtf(fmax(0.0f, ((roomy_t_faustpower2_f(fSlow29) / roomy_t_faustpower2_f(fSlow30)) + -1.0f)));
	...
	float fSlow37 = roomy_t_faustpower2_f(fSlow36);
	float fSlow38 = (1.0f - (fSlow13 * fSlow37));
	float fSlow39 = (1.0f - fSlow37);
	float fSlow40 = (fSlow38 / fSlow39);
	float fSlow41 = sqrtf(fmax(0.0f, ((roomy_t_faustpower2_f(fSlow38) / roomy_t_faustpower2_f(fSlow39)) + -1.0f)));
	...
	float fSlow46 = roomy_t_faustpower2_f(fSlow45);
	float fSlow47 = (1.0f - (fSlow13 * fSlow46));
	float fSlow48 = (1.0f - fSlow46);
	float fSlow49 = (fSlow47 / fSlow48);
	float fSlow50 = sqrtf(fmax(0.0f, ((roomy_t_faustpower2_f(fSlow47) / roomy_t_faustpower2_f(fSlow48)) + -1.0f)));
	...
	float fSlow55 = roomy_t_faustpower2_f(fSlow54);
	float fSlow56 = (1.0f - (fSlow13 * fSlow55));
	float fSlow57 = (1.0f - fSlow55);
	float fSlow58 = (fSlow56 / fSlow57);
	float fSlow59 = sqrtf(fmax(0.0f, ((roomy_t_faustpower2_f(fSlow56) / roomy_t_faustpower2_f(fSlow57)) + -1.0f)));
	...
	float fSlow64 = roomy_t_faustpower2_f(fSlow63);
	float fSlow65 = (1.0f - (fSlow13 * fSlow64));
	float fSlow66 = (1.0f - fSlow64);
	float fSlow67 = (fSlow65 / fSlow66);
	float fSlow68 = sqrtf(fmax(0.0f, ((roomy_t_faustpower2_f(fSlow65) / roomy_t_faustpower2_f(fSlow66)) + -1.0f)));
	...
	float fSlow73 = roomy_t_faustpower2_f(fSlow72);
	float fSlow74 = (1.0f - (fSlow13 * fSlow73));
	float fSlow75 = (1.0f - fSlow73);
	float fSlow76 = (fSlow74 / fSlow75);
	float fSlow77 = sqrtf(fmax(0.0f, ((roomy_t_faustpower2_f(fSlow74) / roomy_t_faustpower2_f(fSlow75)) + -1.0f)));
	...
	float fSlow82 = roomy_t_faustpower2_f(fSlow81);
	float fSlow83 = (1.0f - (fSlow13 * fSlow82));
	float fSlow84 = (1.0f - fSlow82);
	float fSlow85 = (fSlow83 / fSlow84);
	float fSlow86 = sqrtf(fmax(0.0f, ((roomy_t_faustpower2_f(fSlow83) / roomy_t_faustpower2_f(fSlow84)) + -1.0f)));
	...
	/* C99 loop */
	{
		...
		for (i = 0; (i < count); i = (i + 1)) {
			...
			dsp->fVec1[(dsp->IOTA & 16383)] = ((0.353553385f * dsp->fRec14[0]) + 9.99999968e-21f);
			float fTemp3 = (float)input1[i];
			dsp->fVec2[(dsp->IOTA & 8191)] = fTemp3;
			float fTemp4 = (0.300000012f * dsp->fVec2[((dsp->IOTA - iSlow26) & 8191)]);
			float fTemp5 = (((0.600000024f * dsp->fRec12[1]) + dsp->fVec1[((dsp->IOTA - dsp->iConst7) & 16383)]) - fTemp4);
			dsp->fVec3[(dsp->IOTA & 1023)] = fTemp5;
			dsp->fRec12[0] = dsp->fVec3[((dsp->IOTA - dsp->iConst9) & 1023)];
			...
			float fTemp6 = (((0.600000024f * dsp->fRec16[1]) + dsp->fVec4[((dsp->IOTA - dsp->iConst13) & 16383)]) - fTemp4);
			dsp->fVec5[(dsp->IOTA & 2047)] = fTemp6;
			dsp->fRec16[0] = dsp->fVec5[((dsp->IOTA - dsp->iConst14) & 2047)];
			...
			dsp->fVec6[(dsp->IOTA & 8191)] = ((0.353553385f * dsp->fRec22[0]) + 9.99999968e-21f);
			float fTemp7 = (dsp->fVec6[((dsp->IOTA - dsp->iConst18) & 8191)] + (fTemp4 + (0.600000024f * dsp->fRec20[1])));
			dsp->fVec7[(dsp->IOTA & 2047)] = fTemp7;
			dsp->fRec20[0] = dsp->fVec7[((dsp->IOTA - dsp->iConst19) & 2047)];
			...
			float fTemp8 = (fTemp4 + ((0.600000024f * dsp->fRec24[1]) + dsp->fVec8[((dsp->IOTA - dsp->iConst23) & 16383)]));
			dsp->fVec9[(dsp->IOTA & 2047)] = fTemp8;
			dsp->fRec24[0] = dsp->fVec9[((dsp->IOTA - dsp->iConst24) & 2047)];
			...
			dsp->fVec10[(dsp->IOTA & 8191)] = ((0.353553385f * dsp->fRec30[0]) + 9.99999968e-21f);
			float fTemp9 = (0.300000012f * dsp->fVec0[((dsp->IOTA - iSlow26) & 8191)]);
			float fTemp10 = (dsp->fVec10[((dsp->IOTA - dsp->iConst28) & 8191)] - (fTemp9 + (0.600000024f * dsp->fRec28[1])));
			dsp->fVec11[(dsp->IOTA & 1023)] = fTemp10;
			dsp->fRec28[0] = dsp->fVec11[((dsp->IOTA - dsp->iConst29) & 1023)];
			...
			dsp->fVec12[(dsp->IOTA & 8191)] = ((0.353553385f * dsp->fRec34[0]) + 9.99999968e-21f);
			float fTemp11 = (dsp->fVec12[((dsp->IOTA - dsp->iConst33) & 8191)] - (fTemp9 + (0.600000024f * dsp->fRec32[1])));
			dsp->fVec13[(dsp->IOTA & 2047)] = fTemp11;
			dsp->fRec32[0] = dsp->fVec13[((dsp->IOTA - dsp->iConst34) & 2047)];
			...
			dsp->fVec14[(dsp->IOTA & 8191)] = ((0.353553385f * dsp->fRec38[0]) + 9.99999968e-21f);
			float fTemp12 = ((fTemp9 + dsp->fVec14[((dsp->IOTA - dsp->iConst38) & 8191)]) - (0.600000024f * dsp->fRec36[1]));
			dsp->fVec15[(dsp->IOTA & 2047)] = fTemp12;
			dsp->fRec36[0] = dsp->fVec15[((dsp->IOTA - dsp->iConst39) & 2047)];
			...
			dsp->fVec16[(dsp->IOTA & 8191)] = ((0.353553385f * dsp->fRec42[0]) + 9.99999968e-21f);
			float fTemp13 = ((dsp->fVec16[((dsp->IOTA - dsp->iConst43) & 8191)] + fTemp9) - (0.600000024f * dsp->fRec40[1]));
			dsp->fVec17[(dsp->IOTA & 1023)] = fTemp13;
			dsp->fRec40[0] = dsp->fVec17[((dsp->IOTA - dsp->iConst44) & 1023)];
			...
			output1[i] = (FAUSTFLOAT)(0.5f * (dsp->fRec0[0] * ((fTemp0 * fTemp3) + (fTemp2 * ((fTemp32 + (dsp->fRec44[2] + (fTemp30 + fTemp31))) + (fSlow3 * ((fTemp32 + (fTemp31 + dsp->fRec44[2])) - fTemp30)))))));
